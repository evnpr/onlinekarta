...
<tr>
	 ...
	 <th><font size="2"> Harga New </font></th>
	    ...
	    <th><font size="2"> Details  New</font></th>

            <th><font size="2"> Harga 2nd </font></th>
            <th><font size="2"> Stok 2nd</font></th>
	    <th><font size="2"> Details 2nd</font></th>	    
</tr>' ;  for($i=0; $i<$num; $i++) {
...
$f6=mysql_result($result2,$dd,"deskripsinew");
$f7=mysql_result($result2,$dd,"deskripsi2nd");
...
<option value="'.$f1.'">'.$f1.'</option>
	...
	<option value="11" '; if($f3==11){ echo 'selected';} echo '>>10</option>
	 ...
	 <td> <textarea name="odetailnew'.$i.'" cols="20" rows="2" >'.$f6.'</textarea></td>
	...
	<option value="11" '; if($f5==11){ echo 'selected';} echo '>>10</option>
	  ...
	  <td> <textarea name="odetail2nd'.$i.'" cols="20" rows="2" >'.$f7.'</textarea></td>
</tr>' ;} echo '
