...
<th width="7%"><font size="1px" face="Arial, Helvetica, sans-serif">Stok</font></th>
<th width="5%"><font size="1px" face="Arial, Helvetica, sans-serif">Harga 2nd</font></th>
<th width="7%"><font size="1px" face="Arial, Helvetica, sans-serif">Stok</font></th>
<th width="19%"><font size="1px" face="Arial, Helvetica, sans-serif">Nama Toko</font></th>
<th width="45%"><font size="1px" face="Arial, Helvetica, sans-serif">Lokasi</font></th>
<th width="25%"><font size="1px" face="Arial, Helvetica, sans-serif" >Last Update</font></th>
</tr>
'; ?>
...
<tr >
<td width="7%"><b><a href="detail.php?merk=<?php echo $_GET['merk'];?>&&hape=<?php echo $_GET['hape'];?>&&toko=<?php echo $f5;?>&&detail=new"><font size="1px" color="#874c00" face="Arial, Helvetica, sans-serif" ><?php if($f1==00  && $f2!=00) echo 'hub kami'; else echo 'Rp'.$f1.'.000,-'; ?></font></a></b></td>
...
<td width="7%"><b><a href="detail.php?merk=<?php echo $_GET['merk'];?>&&hape=<?php echo $_GET['hape'];?>&&toko=<?php echo $f5;?>"><font size="1px" color="#874c00" face="Arial, Helvetica, sans-serif" ><?php if($f3==00  && $f4!=00) echo 'hub kami'; else echo 'Rp'.$f3.'.000,-'; ?></font></a></b></td>
...
<td width="19%"><a href="detail.php?merk=<?php echo $_GET['merk'];?>&&hape=<?php echo $_GET['hape'];?>&&toko=<?php echo $f5;?>&&detail=toko"><font size="1px" face="Arial, Helvetica, sans-serif"><?php echo $f5; ?></font></a></td>
<td width="45%"> <font size="1" face="Arial, Helvetica, sans-serif"><?php echo $f6; ?></font></td>
