...
mysql_select_db($dbname) or DIE('Database name is not available!');	// include your code to connect to DB.
	...
	*/
	...
	$targetpage = "indexlist.php?kat=$kat&kategori=$kategori&kat1=$kat1&kat2=$kat2&kat3=$kat3&prop=$prop&dae=$dae"; 	//your file name  (the name of this file)
...
?>
		...
		} echo '<div style="background-color:#bebebe; text-align:left; font-size:100%; padding-left:20px; "><font size="2"color="#bebebe">a</font></div>' ;
	?>
